#ifndef _SCENE_5_INCLUDE
#define _SCENE_5_INCLUDE
...
class Scene5 : public GeneralScene
{
public:
	Scene5(glm::ivec2 posPlayer);
	~Scene5();
	...
	void updateEnemy(int deltaTime, glm::ivec2 playerPosition);
	void updateWater(int deltaTime);
	void updateFire(int deltaTime);
	void updateWalkingEnemy(int deltaTime);
