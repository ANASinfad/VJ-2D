...
{
	initShaders();
	map = TileMap::createTileMap("levels/IntroLevel.txt", glm::vec2(SCREEN_X, SCREEN_Y), texProgram);
...
void IntroScene::update(int deltaTime)
{
	...
	if (Game::instance().getKey('z')) Game::instance().changeScene(10, glm::ivec2(0, 0), nullptr);
}
